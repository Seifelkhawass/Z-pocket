...
export default function InvestmentVideo() {
  ...
  const loadWatchedVideos = async () => {
    try {
      const key = `watchedVideos_Investment_${userData?.username}`;
  ...
  const handleStartQuiz = () => {
    router.push('/modules/Investment/Quiz');
  };
      ...
      >
        ...
        >
          <Text style={{ color: '#fff', fontSize: 18, marginBottom: 20 }}>
            Watch these videos to learn about crypto investment strategies. Mark them as watched when you're done.
          </Text>
