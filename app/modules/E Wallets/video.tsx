...
export default function WalletsVideo() {
  ...
  const loadWatchedVideos = async () => {
    try {
      const key = `watchedVideos_E_Wallets_${userData?.username}`;
  ...
  const handleStartQuiz = () => {
    router.push('/modules/E Wallets/Quiz');
  };
      ...
      >
        ...
        >
          <Text style={{ color: '#fff', fontSize: 18, marginBottom: 20 }}>
            Watch these videos to learn about crypto wallets. Mark them as watched when you're done.
          </Text>
