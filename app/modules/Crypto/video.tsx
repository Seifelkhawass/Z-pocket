...
export default function CryptoVideo() {
  ...
  const loadWatchedVideos = async () => {
    try {
      const key = `watchedVideos_Crypto_${userData?.username}`;
  ...
  const videos = [
    ...
    },
    {
      ...
      duration: '15:00',
      url: 'https://www.youtube.com/watch?v=6Gu2QMTAkEU',
    },
    {
      id: '3',
      ...
      >
        ...
        >
          <Text style={{ color: '#fff', fontSize: 18, marginBottom: 20 }}>
            Watch these videos to learn about cryptocurrency. Mark them as watched when you're done.
          </Text>
